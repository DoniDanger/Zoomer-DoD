...
military = {
	...
	NAVAL_LOW_SUPPLY_DAMAGE_SUPPLY_STATUS = 0.40, -- how little supply is acceptable before getting damage to STR
	NAVAL_LOW_SUPPLY_DAMAGE_DAYS_DELAY = 25, -- delay in days before the STR will get damage due to no supplies. Sometimes supply status may jump bcoz of the market.
...
diplomacy = {
    ...
    BREAKTRUCE_INFAMY_ADD_TO_SPHERE = 5,
    BREAKTRUCE_INFAMY_RELEASE_PUPPET = 5,
    BREAKTRUCE_INFAMY_MAKE_PUPPET = 5,
    BREAKTRUCE_INFAMY_DISARMAMENT = 5,
    BREAKTRUCE_INFAMY_DESTROY_FORTS = 5,
    BREAKTRUCE_INFAMY_DESTROY_NAVAL_BASES = 5,
    BREAKTRUCE_INFAMY_REPARATIONS = 5,
    BREAKTRUCE_INFAMY_TRANSFER_PROVINCES = 5,
    BREAKTRUCE_INFAMY_REMOVE_CORES = 0,
    BREAKTRUCE_INFAMY_PRESTIGE = 5,
    BREAKTRUCE_INFAMY_CONCEDE = 5,
    BREAKTRUCE_INFAMY_STATUS_QUO = 5,
    BREAKTRUCE_INFAMY_ANNEX = 5,
    BREAKTRUCE_INFAMY_DEMAND_STATE = 5,
    BREAKTRUCE_INFAMY_INSTALL_COMMUNIST_GOV_TYPE = 5,
    BREAKTRUCE_INFAMY_UNINSTALL_COMMUNIST_GOV_TYPE = 5,
    BREAKTRUCE_INFAMY_COLONY = 5,

    BREAKTRUCE_PRESTIGE_ADD_TO_SPHERE = -25,
    BREAKTRUCE_PRESTIGE_RELEASE_PUPPET = -25,
    BREAKTRUCE_PRESTIGE_MAKE_PUPPET = -25,
    BREAKTRUCE_PRESTIGE_DISARMAMENT = -25,
    BREAKTRUCE_PRESTIGE_DESTROY_FORTS = -25,
    BREAKTRUCE_PRESTIGE_DESTROY_NAVAL_BASES = -25,
    BREAKTRUCE_PRESTIGE_REPARATIONS = -25,
    BREAKTRUCE_PRESTIGE_TRANSFER_PROVINCES = -25,
    BREAKTRUCE_PRESTIGE_REMOVE_CORES = 0,
    BREAKTRUCE_PRESTIGE_PRESTIGE = -25,
    BREAKTRUCE_PRESTIGE_CONCEDE = -25,
    BREAKTRUCE_PRESTIGE_STATUS_QUO = -25,
    BREAKTRUCE_PRESTIGE_ANNEX = -25,
    BREAKTRUCE_PRESTIGE_DEMAND_STATE = -25,
    BREAKTRUCE_PRESTIGE_INSTALL_COMMUNIST_GOV_TYPE = -25,
    BREAKTRUCE_PRESTIGE_UNINSTALL_COMMUNIST_GOV_TYPE = -25,
    BREAKTRUCE_PRESTIGE_COLONY = -25,
    ...
    INCREASERELATION_DIPLOMATIC_COST = 3,
